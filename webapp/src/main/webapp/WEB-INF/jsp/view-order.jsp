                        ...
                        <c:otherwise>
                            <div class="row">
                                <div class="col-4 float-left">
                                    <ul class="nav flex-column overflow-auto" id="myTab" role="tablist">
                                            ...
                                            <div id="res-${result.id}" class="tab-pane fade tab-result">
                                                <div class="card overflow-auto border-primary">
                                                    <div class="card-body">
                                                        ...
                                                        <img src="${imageAssets}/result/${encodedId}/${result.id}/result-data" class="align-self-end ml-3" alt="/assets/image/result/${id}/result-data" style="max-height:15rem; max-width:20rem">
                                                        <hr class="mt-5 mb-4"/>
                                                        <div class="media">
                                                            <div class="media-body">
                                                            ...
                                                            <img src="${imageAssets}/result/${encodedId}/${result.id}/identification" class="ml-1" alt="/assets/image/result/${id}/identification" style="width: 5rem;">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
