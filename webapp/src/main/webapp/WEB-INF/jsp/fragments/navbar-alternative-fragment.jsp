<nav class="navbar-expand-lg fixed-top py-3 navbar bg-primary" id="mainNav">
    <div class="container">
        <c:url value="/" var="homepage" />
        <a class="navbar-title text-white" href="${homepage}"><i class="fas fa-laptop-medical fa-lg"></i>&nbsp;&nbsp;/&nbsp;&nbsp;<spring:message code="appname"/></a>
