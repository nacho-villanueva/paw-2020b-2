<nav class="navbar-expand-lg fixed-top py-3 navbar bg-light" id="mainNav">
    <div class="container">
        ...
        <c:url value="/advanced-search/clinic" var="clinicSearch" />
        ...
        <div class="" id="navbarResponsive">
            <ul class="navbar-nav ml-auto my-2 my-lg-0">
                <li class="nav-item"><a class="navbar-options" href="${clinicSearch}"><spring:message code="fragments.navbar.clinic-search"/></a></li>
            </ul>
        </div>
    </div>
</nav>